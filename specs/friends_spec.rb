...
class TestFriends < MiniTest::Test
  ...
  def test_return_favourite_show
  ...
  def test_likes_to_eat
    result = check_likes_to_eat(@person5, "spinach")
  ...
  def test_add_friend
    add_friend(@person5, "Scrappy Doo")
...
def test_remove_name
  ...
  def test_total_monies
    assert_equal(143, @person[:monies].sum)
  end
